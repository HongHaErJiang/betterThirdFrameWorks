...
#import "UIScrollView+scrollViewGzw.h"
#import <objc/runtime.h>
@implementation UIScrollView (scrollViewGzw)
static const BOOL loadingKey;
static const char loadedImageNameKey;
static const char descriptionTextKey;
static const char titleTextKey;
...
- (void)setTitleText:(NSString *)titleText {
    ...
    objc_setAssociatedObject(self, &titleText, titleText, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
- (NSString *)titleText {
    return objc_getAssociatedObject(self, &titleTextKey);
}
-(NSString *)buttonText
{
...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView
{
    if (self.loading) {
        ...
        NSDictionary *attributes = @{NSFontAttributeName: [UIFont fontWithName:@"STHeitiSC-Medium" size:14.],
...
- (NSAttributedString *)descriptionForEmptyDataSet:(UIScrollView *)scrollView
{
    if (self.loading) {
        ...
        NSDictionary *attributes = @{NSFontAttributeName: [UIFont fontWithName:@"STHeitiSC-Light" size:12.],
                                     NSForegroundColorAttributeName: [UIColor colorWithHexString:@"b6b6b6"],
                                     NSParagraphStyleAttributeName: paragraph};
